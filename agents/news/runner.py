...
def _model_for(provider: str) -> str:
    if provider == 'claude':
        # Default: Haiku 4.5 — ~$0.15 pro Daily-Run statt ~$1.66 mit Sonnet,
        # bei für News-Summary völlig ausreichender Qualität. Override per
        # NEWS_AGENT_MODEL_CLAUDE=claude-sonnet-4-6 falls Qualität nicht reicht.
        return os.getenv('NEWS_AGENT_MODEL_CLAUDE', 'claude-haiku-4-5-20251001')
    if provider == 'ollama':
